...
const Contact = () => {
  return (
    ...
    <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
        ...
        <form action="https://getform.io/f/87c6bdf0-0b6f-4a99-ac81-b340c22763c7" method='POST' className='flex flex-col w-full md:w-1/2'>
 ...
 <button className='text-white bg-gradient-to-b from-cyan-500 to-blue-500 px-6 py-3'>Get in touch</button>
      </form>
        </div>
